...
class MutiLocation(private val activity: Activity): Service(), LocationListener {
    ...
    private val MIN_DISTANCE_CHANGE_FOR_UPDATES: Float =
        10f // The minimum distance to change Updates in meters
    private val MIN_TIME_BW_UPDATES: Long =
        1000 * 60 * 1 // The minimum time between updates in milliseconds
